...
func InitApp(cfg *config.Config, dbConnStr postgres.DBConnString, rabbitMQConnStr rabbitmq.RabbitMQConnStr) (*App, func(), error) {
	...
	cookOrderedEventHandler := eventhandlers.NewCookOrderedEventHandler(dbEngine, eventPublisher)
	app := New(cfg, dbEngine, connection, eventPublisher, eventConsumer, cookOrderedEventHandler)
	return app, func() {
		cleanup2()
		cleanup()
	}, nil
