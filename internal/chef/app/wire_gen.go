...
func InitApp(cfg *config.Config, dbConnStr postgres.DBConnString, rabbitMQConnStr rabbitmq.RabbitMQConnStr) (*App, func(), error) {
	...
	chefOrderedEventHandler := eventhandlers.NewChefOrderedEventHandler(dbEngine, eventPublisher)
	app := New(cfg, dbEngine, connection, eventPublisher, eventConsumer, chefOrderedEventHandler)
	return app, func() {
		cleanup2()
		cleanup()
	}, nil
