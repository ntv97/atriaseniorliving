...
import (
	...
	"github.com/ntv97/atriaseniorliving/internal/waitstaff/app"
...
func prepareApp(ctx context.Context, cancel context.CancelFunc, cfg *config.Config, server *grpc.Server) func() {
	...
	a.Consumer.Configure(
		pkgConsumer.ExchangeName("waitstaff-order-exchange"),
		pkgConsumer.QueueName("waitstaff-order-queue"),
		pkgConsumer.BindingKey("waitstaff-order-routing-key"),
		pkgConsumer.ConsumerTag("waitstaff-order-consumer"),
	)*/
